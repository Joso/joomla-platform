...
class JDatabaseSQLSrv extends JDatabase
{
	 ...
	 * @param   boolean       $typeonly  Only return field types, default true
	 *
	 ...
	 *
	 * @param   object  $table  The tabe object.
	 *
	 * @return boolean
	 */
